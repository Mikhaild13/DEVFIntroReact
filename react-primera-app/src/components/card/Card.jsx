...
export default function Card(props) {
  // Un estado se crea con base a una constante y teniendo un valor inicial
  // El counter es el valor que se va a modificar (variable)
  // El setCounter es la funcion que va a modificar al counter
    ...
    <>
      <div className="card-style">
        <img src="data:image/jpeg;base64," alt=""/>
          ...
          <Link to={`/celulares/${props.item.title}`} state={props.item}>
            <button type="button" className="btn btn-primary" onClick={handlerCounter}>
              push me
            </button>
          </Link>
      </div>
